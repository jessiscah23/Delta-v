    ...
    IComputerWindow<EmergencyConsoleBoundUserInterfaceState>
{
    ...
    public event Action? ReleaseButtonPressed;
    ...
    public OfferingWindow()
    {
        ...
        ReleaseButton.OnPressed += OnRelease;
    }
    ...
    protected override void FrameUpdate(FrameEventArgs args)
    {
        ...
        if (_progression != null)
        {
            ...
            if (remaining < TimeSpan.Zero)
            {
                ...
                //Release button is grey
                //release button text = "No Active Pull"
            }
            else
            {
    ...
    private void OnRelease(BaseButton.ButtonEventArgs buttonEventArgs)
    {
        ReleaseButtonPressed?.Invoke();
    }
}
